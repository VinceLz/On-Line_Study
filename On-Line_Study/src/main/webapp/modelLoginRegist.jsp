...
<script type="text/javascript"
	src="User/bootstrap/js/jquery-1.11.3.min.js"></script>
			...
			<div class="collapse navbar-collapse item_list"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<c:if test="${user!=null }">
						...
						<li><a href="#loginon" class="scrollto loginon"
							title="Login or Register" data-toggle="modal"
							data-target="#lgAndRg" onClick="showLoginon()"><span>欢迎您${user.nickName }</span></a></li>
						<li><a href="#register" class="scrollto register"
							title="Login or Register" data-toggle="modal"
							data-target="#lgAndRg" onClick="showRegister()"><span>退出</span></a></li>
  ...
  <div class="nav_bar_con clearfix">
    <div class="notice_header">
      <ul class="clearfix">
        ...
        <li class="notice_active"><a href="#">消息</a></li>
      </ul>
    </div>
