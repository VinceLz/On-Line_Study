...
<section id="main-content">
	<section class="wrapper">
		<h3>
			<i class="fa fa-angle-right"></i>修改资源项
		</h3>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input name="resourceId" value="${resource.id }"
									...
									placeholder="${resource.id}" readOnly="true">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="uploadeDate"
									value="${resource.uploadeDate }" id="disabledInput"
									readOnly="true">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="src"
									value="${resource.src }" id="disabledInput" readOnly="true">
								<button type="button" class=" btn btn-theme"
									onclick="location='AdminResourceServlet?method=showUploadResource&resourceSrc=${resource.src }&resourceId=${resource.id}'">上传资源</button>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input class="form-control" type="text" name="beLongToDegreeID"
									value="${resource.beLongToDegreeID}">
							</div>
						</div>
						<c:if test="${admin_teacher.rank eq 1}">
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="type">
										<option value="0"
											<c:if test="${resource.type eq 0 }">selected = "selected"</c:if>>是</option>

										<option value="${admin_tacher.id}"
											<c:if test="${resource.type eq admin_teacher.id }">selected = "selected"</c:if>>否</option>
									</select>
								</div>
							</div>
						</c:if>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input class="form-control" type="text" name="showImageSrc"
									value="${resource.showImageSrc}" readOnly="true">
								<button type="button" class=" btn btn-theme"
									onclick="location='AdminResourceServlet?method=showUploadShowImageSrc&resourceShowImageSrc=${resource.showImageSrc }&resourceId=${resource.id}'">上传图片</button>
