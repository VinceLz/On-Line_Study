                  ...
                  <div class="form-panel">
                      ...
                      <input type="hidden" name="method" value="addMenu" /> 
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="parentMenuId" value="0">
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="menuAddr" value="例如  adn.jsp">
                              </div>
                          </div>                      
                          <div class="form-group">
                          ...
                          <button type="submit" class=" btn btn-theme">添加菜单项</button>
                      </form>
                  </div>
          		</div><!-- col-lg-12-->      	
          	</div><!-- /row -->      	
