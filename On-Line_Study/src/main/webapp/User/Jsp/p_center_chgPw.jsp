			...
			<div class="row">
				<div class="col-md-2">
					<ul class="nav nav-pills nav-stacked" role="tablist">
						...
						<li  role="presentation"><a href="<%=path %>/PCenterServlet?method=ForwdCenter_Forum"><span style="margin-right: 10%;" class="glyphicon glyphicon-list"></span>论坛<span id="forRight" class="glyphicon glyphicon-chevron-right"></span></a></li>
						...
						<li  role="presentation" class="active"><a href="<%=path %>/PCenterServlet?method=ForwdCenter_ChgPw"><span style="margin-right: 10%;" class="glyphicon glyphicon-edit"></span>修改密码<span id="forRight" style="margin-left: 10%" class="glyphicon glyphicon-chevron-right"></span></a></li>
					</ul>
				</div>
				<div class="col-md-10">
				  <div class="panel panel-default" style="height: 550px;">
				   <div class="panel-heading">
				    ...
				    <div class="col-md-8"> 
				     <table class="table table-condensed  " style="margin-top: 10%;" >
				          <form class="form">
				                 <tr >
				                      <div class="form-group" >
				                         <td style="line-height: 200%; text-align: right; ">
				                           <p for="inputPassword" class="">原始密码:</p>
				                          </td> 
				                           <td>
                                                <div class="col-sm-7">
                                                          <input type="text" class="form-control" id="" placeholder="请输入原始密码">
                                                </div>
                                            </td>
				                      </div>           
				                 </tr>
				                 <tr>
				                      <div class="form-group">
				                         <td style="line-height: 200%; text-align: right;">
				                           <label for="inputPassword" class="">新密码:</label>
				                          </td> 
				                           <td>
                                                <div class="col-sm-7">
				                ...
				                <tr>
				                      <div class="form-group">
				                         <td style="line-height: 200%;text-align: right;">
				                           <label for="inputPassword" class="">重复新密码:</label>
				                          </td> 
				                           <td>
                                                <div class="col-sm-7">
                                                          <input type="password" class="form-control" id="" placeholder="请再次输入新密码">
                                                </div>
                                            </td>
				                      </div>           
				                 </tr>
				                      ...
				                      <div class="form-group">
				                           <td colspan="2" style="text-align: center;padding-top: 3%;"> 
                                              <div class="col-sm-8" style="margin-left: 10%;">
                                                         <input type="reset"  value="重置" class="btn btn-info" style="margin-right: 15px;">
				   ...
				   <!--  <div class="panel-heading">
				    ...
				    <div class="panel-body">
				         <div class="container">
				               ...
				               <div class="col-md-8">
				                 <form action=""  class="form-horizontal" role="form" placeholder="请输入原始密码">	          
						             <div class="form-group">
						                <input type="text" class="form-control" name="oldPwd" style="width: 50%;"/>
						             </div>
				                </form>
				              </div>
				         </div>
