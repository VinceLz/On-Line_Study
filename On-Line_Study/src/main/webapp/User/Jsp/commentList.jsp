				...
				<ul class="nav navbar-nav navbar-right">
					<form class="navbar-form navbar-left" role="search">
						<a href="#Serch" data-toggle="modal" data-target="#lgAndRgS">
							<span class="glyphicon glyphicon-search search_c"></span>
						</a>
					</form>
					...
					<c:if test="${user!=null }">
						<li><a
							href="<%=path%>/IndexDoorServlet?method=forowdMessage"
						...
						<li class="nav-item"><a class=""
							href="<%=path%>/UserServlet?method=forowdMyForumList">我的帖子</a>
						</li>
	...
	<div data-ride="carousel" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="item active">
				<img src="User/Jsp/Images/banner_box1.jpg" alt="第1张"
					class="item_img">
			</div>
			<div class="item">
				<img src="User/Jsp/Images/banner_box2.jpg" alt="第2张"
					class="item_img">
			</div>
			<div class="item">
				<img src="User/Jsp/Images/banner_box3.jpg" alt="第3张"
					class="item_img">
			</div>
		</div>

		<!-- 圆圈指示符 -->
		<ol class="carousel-indicators carousel-span">
			<li data-slide-to="0" data-target="#carousel-container"
				class="active"></li>
			<li data-slide-to="1" data-target="#carousel-container"></li>
			<li data-slide-to="2" data-target="#carousel-container"></li>
		</ol>
		<div class="car_text">
			<a href="#" class="item_tag">热点帖子</a>
			<h3>
				<a
					href="<%=path %>/IndexDoorServlet?method=forowdCommentInfo&id=${forumList.get(0).id}"
					target="dakai">${forumList.get(0).title }</a>
			</h3>
			<hr>
			<div class="post-element">
				<span><a target="dakai"
					href="<%=path %>/IndexDoorServlet?method=forowdCommentInfo&id=${forumList.get(0).id}"><img
						src="<%=path %>${forumList.get(0).userURL }">${forumList.get(0).pub_account
						}</a>
				</span> <span><i class="fa fa-clock-o"></i>发表时间：${forumList.get(0).pub_date
					}</span> <span><i class="fa fa-eye"></i>点击量：${forumList.get(0).support
					} </span>
			</div>
			<p class="texttext">${forumList.get(0).content }</p>
			<a
				href="<%=path %>/IndexDoorServlet?method=forowdCommentInfo&id=${forumList.get(0).id}"
				class="redeAll">阅读全文</a>
		</div>

		<!-- 左右控制 -->
		<a data-slide="prev" href="#carousel-container"
			class="left carousel-control"> <span
			class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> </a>
		<a data-slide="next" href="#carousel-container"
  ...
  <p>先<a href="#loginon" id="loginon" title="Login or Register" data-toggle="modal" data-target="#lgAndRg" onClick="showLoginon()"><span>登录</span></a>才能查看更多文章</p>
	...
	<div id="container" class="wrap">
		<div class="content_box">
			<ul class="list_art">
				<c:forEach items="${forumList}" var="forum" begin="1">
					<li>
						<div class="backimg">
							<p>科技前沿</p>
						</div>
						<div class="con_img">
							<a
								href="<%=path %>/IndexDoorServlet?method=forowdCommentInfo&id=${forum.id}"
								target="dakai"> <img class="home-thumb"
								src="${forum.picture }" alt="${forum.title }">
								<p class="webfont">
						...
						<div class="con_text">
							<h2>
								<a
									href="<%=path %>/IndexDoorServlet?method=forowdCommentInfo&id=${forum.id}"
									target="dakai" title="${forum.title }">${forum.title }</a>
							</h2>
							<div class="backimg2">
								<p class="texttext">${forum.content }</p>
								<div class="post-element">
									<span><a target="dakai" href="#"><img
											src="<%=path %>${forumList.get(0).userURL }">${forum.pub_account
											}</a>
									</span> <span><i class="fa fa-clock-o"></i>发表日期：${forum.pub_date
										}</span> <span><i class="fa fa-eye"></i>点击量：${forum.support }
									</span>
								</div>
							</div>
						</div></li>
		...
		<div class="sidebar">
			...
			<div class="nei_box">
				...
				<div class="contact">
					...
					</a> <a href="#" class="email"><i class="fa fa-weibo"></i>
					</a> <a href="#" class="weixin"><i class="fa fa-weixin"></i>
					</a> <a href="#" class="qq"><i class="fa fa-qq"></i>
					</a>
				</div>
			</div>
		</div>
			...
			<div class="modal-content">
								...
								<fieldset>
									...
									<div class="checkbox">
										<label> <input type="checkbox"> 记住密码 </label> <span
											style="float:right"><a href="#">找回密码</a>
										</span>
									</div>
									<div class="">
				...
				<div class="modal-footer">
					<span>用第三方登陆</span> <a href="#"><img class="inco1"
						src="Images/Home/qq.jpg">
					</a> <a href="#"><img class="inco1" src="Images/Home/wechat.jpg">
					</a> <a href="#"><img class="inco1" src="Images/Home/sina.jpg">
					</a>
				</div>
			</div>
		</div>
