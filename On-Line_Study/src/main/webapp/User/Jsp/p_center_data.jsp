...
<li  role="presentation"  class="active"><a href="<%=path %>/PCenterServlet?method=ForwdCenter_Data"><span style="margin-right: 10%;" class="glyphicon glyphicon-folder-open"></span>资料<span id="forRight" class="glyphicon glyphicon-chevron-right"></span></a></li>
