...
<li  role="presentation" class="active"><a href="<%=path %>/PCenterServlet?method=ForwdCenter_Track"><span style="margin-right: 10%;" class="glyphicon glyphicon-stats"></span>足迹<span id="forRight" class="glyphicon glyphicon-chevron-right"></span></a></li>
