...
<nav class="navbar navbar-inverse navbar-static-top">
  <div class="container-fluid nav_bar_con"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand logo" href="<%=path %>/User"><img alt="Brand" src="<%=path %>/${indexModel.logoImageSrc }"></a> </div>
    ...
    <div class="nav_bar_con">
        ...
        <div class="kind_nav clearfix">
        	<dl class="kind_row clearfix">
            	<dt>方向：</dt>
                <dd class="kind_all"><a href="<%=path %>/User/Jsp/kind_f.jsp" class="kind_avtive">全部</a></dd>
                <dd class="kind_text clearfix">
                	<ul class="clearfix">
                	<c:forEach items="${interestList }" var="interest">
                		<li><a class="${interest.attribute } interestClass" href="<c:url value='/CategoryServlet?method=showCategoryByInterest&interestId=${interest.id }'/>" >${interest.interestName }</a></li>
                	</c:forEach>
                    </ul>
                </dd>
            </dl>
            <dl class="kind_row clearfix">
                ...
                <dd class="kind_text">
                    ...
                    <c:forEach items="${categoryList }" var="category">
                    	<li><a class="${category.categoryLink }" href="<c:url value='/CategoryServlet?method=showResourceByChooseCategory&categoryId=${category.categoryId }&interestId=${category.beLongToInterestID }'/>">${category.categoryName }</a></li>
                    </c:forEach>
                    </ul>
                </dd>
            </dl>
        ...
        <div class="kind_tit">
        	<ul class="clearfix">
            	<li><a href="<c:url value='/CategoryServlet?method=showResourceByChooseNew&categoryId=${categoryId }&interestId=${interestId }'/>">最新</a></li>
                <li><a href="<c:url value='/CategoryServlet?method=showResourceByChooseHot&categoryId=${categoryId }&interestId=${interestId }'/>">最热</a></li>
                <li><a href="<c:url value='/CategoryServlet?method=showResourceByChoosePut&categoryId=${categoryId }&interestId=${interestId }'/>">推荐</a></li>
            </ul>
        </div>
    </div>
</div>
    	...
    	<div class="row">
    		<c:forEach items="${resourceList}" var="resource">
     			<div class="col-md-3 col-sm-6">
    				<div class="kind_con">
                		<a href="<%=path %>${resource.linkSrc }<%="&id="%>${resource.id}"><img src="${resource.showImageSrc }"  width="170"  height="96"></a>
                  	  	<a href="<%=path %>${resource.linkSrc }<%="&id="%>${resource.id}"><p class="kind_p">${resource.resourceName }</p></a>
                   	 	<a href="<%=path %>${resource.linkSrc }<%="&id="%>${resource.id}"><p>${resource.resume }</p></a>
                    	<p class="clearfix"><span class="fl"><fmt:formatDate value="${resource.uploadeDate }" pattern="yyyy-MM-dd HH:mm:ss" /></span><span class="fr"><span class="glyphicon glyphicon-thumbs-up" style="color:#ff9966;"></span>${resource.likeSum }</span></p>
  ...
  <div class="container-fluid nav_bar_con">
    <div class="footercon clearfix">
      ...
      <div class="WeChat col-sm-2 clearfix">
        <p>微信公众号</p>
        <img class="aa" src="<%=path %>${indexModel.footerWeChat}"> </div>
    </div>
    <hr>
