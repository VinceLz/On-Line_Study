...
<li  role="presentation" class="active"><a href="<%=path %>/PCenterServlet?method=ForwdCenter_Note"><span style="margin-right: 10%;" class="glyphicon glyphicon-list-alt"></span>笔记<span id="forRight" class="glyphicon glyphicon-chevron-right"></span></a></li>
