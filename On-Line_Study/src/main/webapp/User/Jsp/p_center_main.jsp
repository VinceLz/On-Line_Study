			...
			<div class="row">
				<div class="col-md-2">
					<ul class="nav nav-pills nav-stacked" role="tablist">
						 <li  role="presentation" class="active"><a href="<%=path %>/PCenterServlet?method=ForwdCenter_Main"><span style="margin-right: 10%;" class="glyphicon glyphicon-home"></span>主页<span id="forRight" class="glyphicon glyphicon-chevron-right"></span></a></li>	
