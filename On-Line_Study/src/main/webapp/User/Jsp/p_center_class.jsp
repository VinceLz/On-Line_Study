...
<li  role="presentation" class="active"><a href="<%=path %>/PCenterServlet?method=ForwdCenter_Class"><span style="margin-right: 10%;" class="glyphicon glyphicon-facetime-video"></span>课程<span id="forRight" class="glyphicon glyphicon-chevron-right"></span></a></li>
