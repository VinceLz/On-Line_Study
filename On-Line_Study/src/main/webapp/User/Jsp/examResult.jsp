...
<body>
	...
	<div id="container" class="wrap">
		<div class="content_box">
			<li class="read" style="width: 800px;height: 1024px;margin-left:50px">
				<c:if test="${msg == null}">
					<p align=center style="font-size: 30px;">您本次是成绩是:${exam.score},下次加油哦</p>
				</c:if>
				<p align=center style="font-size: 30px;">${msg}</p>
			</li>
		</div>
	</div>
