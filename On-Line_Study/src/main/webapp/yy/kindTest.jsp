...
<html lang="zh-CN">
  ...
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <img src="${indexModel.logoImageSrc }" width="40px">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <c:forEach items="${menuList }" var="menu">
              <li><a href="${menu.menuAddr }">${menu.menuName }</a></li>     
      </c:forEach>
<!--
...
-->
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><div style="color:#CCC" style="float:LEFT"><img src="User/images/touxiang.png"/>&nbsp;&nbsp;&nbsp;个人中心</div></li>
    ...
    <hr/>
     <div class="row">
      ...
      <c:forEach items="${interestList }" var="interest">
      	<div class="col-md-1"><a>${interest.interestName }</a></div>
      </c:forEach>
<!--
 ...
 -->
	...
	<p style=" line-height:10px">&nbsp;</p>
     <div class="row">
      ...
      <c:forEach items="${allDetailList }" var="detail">
      	<div class="col-md-1"><a>${detail }</a></div>
      </c:forEach>
<!-- 
 ...
 -->
	...
	<c:forEach items="${resourceList }" var="resource">
      <div class="col-sm-6 col-md-3">
        <div class="thumbnail">
          <img src="${resource.showImageSrc }">
          <div class="caption">
           <div class="clearfix">
            <h5>${resource.resourceName }</h5>
            <div class="pull-left" style="color:#848383;">讲师：blue</div>
            <div class="pull-right" style="color:#848383;">${resource.likeSum }</div>
          </div>
          </div>
        </div>
      </div>
